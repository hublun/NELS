...
source("data-code-ludwig/clean_scripts/data_preparation.R");
...
source("data-code-ludwig/clean_scripts/demog_clean.R");

# Cleans BY academic variables
source("data-code-ludwig/clean_scripts/BYacad_clean.R");

# Cleans FU1 academic variables
source("data-code-ludwig/clean_scripts/FU1acad_clean.R");

# Cleans FU2 academic variables
source("data-code-ludwig/clean_scripts/FU2acad_clean.R");

# Cleans FU3 academic variables
source("data-code-ludwig/clean_scripts/FU3acad_clean.R");

# Cleans FU1 activities variables
source("data-code-ludwig/clean_scripts/FU1act_clean.R");

# Cleans FU2 activities variables
source("data-code-ludwig/clean_scripts/FU2act_clean.R");
...
source("data-code-ludwig/covmtx_build.R")
